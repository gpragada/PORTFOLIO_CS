      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            ...
            className="inline-block px-10 py-4 font-mono text-lg bg-accent text-primary-bg rounded-md hover:bg-opacity-80 transition-all duration-300 shadow-lg hover:shadow-accent-1/30"
          >
            Say Hello
          </a>
